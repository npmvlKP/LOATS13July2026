...
def main():
    ...
    files_to_fix = [
        (project_root / 'src' / 'loats' / 'database_async_additions.py', add_i001_noqa_to_database_async_additions),
        (project_root / 'src' / 'loats' / 'database_async_additions_temp.py', add_i001_noqa_to_database_async_additions),
        (project_root / 'scripts' / 'benchmark_performance.py', add_i001_noqa_to_benchmark_scripts),
        (project_root / 'scripts' / 'benchmark_supertrend.py', add_i001_noqa_to_benchmark_scripts),
    ]
