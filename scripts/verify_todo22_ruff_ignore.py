...
def check_pyproject_toml():
    ...
    if found:
        ...
        print("✅ PASS: E402, I001, PGH003 are not in global ignore list")
        return True
...
def verify_inline_noqa():
    ...
    returncode, stdout, stderr = run_command(
        ["git", "grep", "-n", "# noqa", "--", "*.py", "src/", "tests/", "scripts/"]
    )
    ...
    if invalid:
        print(
            f"⚠️  WARNING: {len(invalid)} noqa comments without specific codes or reasons"
        )
