...
def generate_summary(
    ...
    benchmark_passing = sum(1 for v in benchmark_validation.values() if v["overall_pass"])
    ...
    return {
        ...
        "benchmark_validation": {
            ...
            "pass_rate": benchmark_passing / benchmark_total if benchmark_total > 0 else 0,
        },
...
def print_summary(summary: Dict[str, Any]) -> None:
    ...
    print(f"Database Operations (ms):")
