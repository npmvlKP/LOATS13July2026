...
class TestNSEHolidays:
    ...
    def test_2027_diwali(self):
        ...
        assert diwali_2027 in NSE_HOLIDAYS, \
            "Diwali 2027 (October 29) must be a holiday"
    ...
    def test_2028_diwali(self):
        ...
        assert diwali_2028 in NSE_HOLIDAYS, \
            "Diwali 2028 (November 2) must be a holiday"
    ...
    def test_2026_holi(self):
        ...
        assert holi_2026 in NSE_HOLIDAYS, \
            "Holi 2026 (March 3) must be a holiday"

    def test_2027_holi(self):
        """Verify Holi 2027 (March 6) is a holiday."""
        holi_2027 = datetime.date(2027, 3, 6)
        assert holi_2027 in NSE_HOLIDAYS, \
            "Holi 2027 (March 6) must be a holiday"

    def test_2028_holi(self):
        """Verify Holi 2028 (February 27) is a holiday."""
        holi_2028 = datetime.date(2028, 2, 27)
        assert holi_2028 in NSE_HOLIDAYS, \
            "Holi 2028 (February 27) must be a holiday"
    ...
    def test_weekend_holidays_documented(self):
        ...
        weekend_holidays = [
            holiday for holiday in NSE_HOLIDAYS
        ...
        if weekend_holidays:
            ...
            for holiday in weekend_holidays:
                logger.info(
                    "Holiday falls on weekend: %s (%s)",
                    holiday, holiday.strftime('%A')
                )
    ...
    def test_year_coverage(self):
        ...
        assert 2026 in years_in_calendar, \
            "Calendar must include 2026 holidays"
        assert 2027 in years_in_calendar, \
            "Calendar must include 2027 holidays"
        assert 2028 in years_in_calendar, \
            "Calendar must include 2028 holidays"
