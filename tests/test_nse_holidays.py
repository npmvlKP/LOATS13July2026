...
from loats.scheduler import NSE_HOLIDAYS, _NSE_HOLIDAY_TUPLES
...
class TestNSEHolidays:
    ...
    def test_holiday_tuples_format(self):
        ...
        for holiday_tuple in _NSE_HOLIDAY_TUPLES:
            ...
            assert (
                isinstance(year, int) and year >= 2026
    ...
    def test_2026_republic_day(self):
        ...
        assert (
            republic_day_2026 in NSE_HOLIDAYS
    ...
    def test_2026_gandhi_jayanti(self):
        ...
        assert (
            gandhi_jayanti_2026 in NSE_HOLIDAYS
    ...
    def test_2026_christmas(self):
        ...
        assert (
            christmas_2026 in NSE_HOLIDAYS
    ...
    def test_2027_republic_day(self):
        ...
        assert (
            republic_day_2027 in NSE_HOLIDAYS
    ...
    def test_2027_independence_day(self):
        ...
        assert (
            independence_day_2027 in NSE_HOLIDAYS
    ...
    def test_2027_gandhi_jayanti(self):
        ...
        assert (
            gandhi_jayanti_2027 in NSE_HOLIDAYS
    ...
    def test_2027_christmas(self):
        ...
        assert (
            christmas_2027 in NSE_HOLIDAYS
    ...
    def test_2028_republic_day(self):
        ...
        assert (
            republic_day_2028 in NSE_HOLIDAYS
    ...
    def test_2028_independence_day(self):
        ...
        assert (
            independence_day_2028 in NSE_HOLIDAYS
    ...
    def test_2028_gandhi_jayanti(self):
        ...
        assert (
            gandhi_jayanti_2028 in NSE_HOLIDAYS
    ...
    def test_2028_christmas(self):
        ...
        assert (
            christmas_2028 in NSE_HOLIDAYS
