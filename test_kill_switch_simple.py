...
async def test_kill_switch_enforcement():
    ...
    with patch('loats.alerts.async_client.get_all_orders', new_callable=AsyncMock) as mock_get_orders:
        ...
        try:
            ...
            print("✓ Kill switch deactivated successfully (manual)")
        except Exception as e:
