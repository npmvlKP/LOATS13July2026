#!/usr/bin/env python3
"""
Quick verification test for idempotency key functionality.
...
def test_idempotency_key_generation():
    ...
    print(f"✓ Same identity returns same key: {key1}")
    ...
    print(
        "✓ Payload digest works correctly: same payloads have same digest, different payloads have different digests"
    )
